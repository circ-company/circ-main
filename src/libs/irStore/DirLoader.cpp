...
void DirLoader::initialize(const StartOptions opts)
{
    FNENTER();
...
void DirLoader::dirIsLoaded(const QString &path)
{
    FNENTER();
    Q_UNUSED(path);
    mDirLoaded = true;
